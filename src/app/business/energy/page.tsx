...
const featuredArticles: Article[] = [
  {
    ...
    imageSrc: "/energy/energy-1.png",
    href: "/article/swiss-minister-meets-us-treasury",
  },
  {
    title: "GE Vernova & Siemens Energy in Talks to Supply Gas Turbines for Syria Reconstruction",
    category: "Crude oil & Market",
    imageSrc: "/energy/energy-2.png",
    href: "/article/rio-grande-expands",
  },
  {
    title: "Oil prices edge lower as U.S. inventory builds and OPEC signals 2026 surplus",
    category: "Crude oil & Market",
    imageSrc: "/energy/energy-3.png",
    href: "/article/macron-ally-lescure",
  },
  {
    title: "Dutch Startup Wave Energy Collective (Weco) Secures €600 000 to Advance Scalable Wave Energy Solutions",
    category: "Breaking News",
    imageSrc: "/energy/energy-4.png",
    href: "/article/oil-edges-17-week-low",
  },
  {
    title: "Bio-LNG Supply Service Debuts at Spain’s Musel Energy Hub Terminal",
    category: "Crude oil & Market",
    imageSrc: "/energy/energy-5.png",
...
const mainArticles: Article[] = [
  {
    ...
    imageSrc: "/energy/energy-6.png",
    href: "/article/opec-output-boost",
  },
  {
    title: "Nigeria’s LPVT Solar Panels Secure Global Certification, Leveraging Local Manufacturing Momentum",
    category: "Upstream Oil",
    imageSrc: "/energy/energy-7.png",
    href: "/article/nupeng-dangote-refinery",
  },
  {
    title: "BP Posts Q3 Profit Beat but Offers No Update on Castrol Sale",
    category: "Upstream Oil",
    imageSrc: "/energy/energy-8.png", 
  ...
  },
  {
    ...
    category: "Upstream Oil",
    imageSrc: "/energy/energy-9.png",
    href: "/article/ncdc-credit-access-deal",
  },
  {
    title: "Coleman Unveils Africa’s Largest Fibre-Optic Cable Plant to Power Nigeria’s Digital and Energy Future",
    category: "Upstream Oil",
    imageSrc: "/energy/energy-10.png",
    href: "/article/airbus-results-order",
  },
  {
    title: "Nigeria’s New Global Gas Role to Spur Investment and Jobs — Minister",
    category: "Upstream Oil",
    imageSrc: "/energy/energy-11.png",
    href: "/article/challenger-energy-offshore",
  },
  {
    title: "TotalEnergies Green-lights Restart of $20 Billion Mozambique LNG Project",
    category: "Upstream Oil",
    imageSrc: "/energy/energy-12.png",
  ...
  },
  {
    ...
    category: "Upstream Oil",
    imageSrc: "/energy/energy-13.png",
    href: "/article/n900bn-injection-banks",
  },
  {
    title: "Nigeria’s Energy Future Depends on Pragmatic Reforms, Sustained Policy Consistency — Dr. Uche Ogah",
    category: "Upstream Oil",
    imageSrc: "/energy/energy-14.png",
    href: "/article/air-peace-lagos-sao-paulo",
  },
  {
    title: "Nigeria’s Energy Transition to Unlock Multi-Billion-Dollar Investments — Sahara Group",
    category: "Upstream Oil",
    imageSrc: "/energy/energy-15.png",
    ...
    <div className="bg-white min-h-screen">
      ...
      <header className="border-b border-gray-200 mt-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 ">
          <h1 className="text-3xl font-bold text-gray-900">ENERGY & POWER</h1>
        </div>
      </header>
