          ...
          <div className="space-y-6 text-gray-700 leading-relaxed text-[15px]">
            ...
            <section>
              ...
              <ul className="list-disc ml-6 space-y-2 text-[18px] text-[#221919]">
                <li>Build a strong relationship with government entities, national Oil companies, traders, 
                    fuel distributors,<br/> producers, consumers, and other stakeholders 
                    and ensure you have them in each if your event as<br/> exhibitor or sponsor.</li>
                <li>Manage all the exhibition and sponsorship projects in all our events.</li>
                <li>Understand and stay informed of important market developments to uncover new business opportunities<br/> for Onewave</li>
                <li>Regularly communicate, verbally and in writing, information from external meetings and information on<br/>
                 market developments to Onewave senior management, editorial, sales, and marketing.</li>
                <li>Leverage knowledge gained from market engagements to help secure sponsors for each of our event.</li>
                <li>Stay on top of the competitive landscape to manage threats and uncover opportunities during the any of<br/> our events</li>
                <li>Secure delegate, sponsors and strategic partners in each of our event.</li>
                <li>Meet all the stakeholders in each event and invite them to our events</li>                
              </ul>
            </section>
