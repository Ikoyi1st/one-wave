...
const featuredArticles: Article[] = [
  {
    title: "Swiss Minister Meets U.S. Treasury Chief — No Breakthrough Yet on Tariffs",
    category: "International Relations",
    imageSrc: "/news/news1.png",
    href: "/article/swiss-minister-meets-us-treasury",
  },
  {
    title: "Rio Grande Expands, FERC Ready to Approve Fifth LNG Train at Texas Facility",
    category: "Energy",
    imageSrc: "/news/news2.png",
    href: "/article/rio-grande-expands",
  },
  {
    title: "Macron Ally Roland Lescure Appointed as France's New Finance Minister",
    category: "National Relations",
    imageSrc: "/news/news3.png",
    href: "/article/macron-ally-lescure",
  },
  {
    title: "Oil edges to 17-week low on US and Asia economic worries, and expected OPEC+ production increase",
    category: "Energy",
    imageSrc: "/news/news4.png",
    href: "/article/oil-edges-17-week-low",
  },
  {
    title: "Saipem strengthens Guyana footprint with $500M contract on ExxonMobil's Hammerhead project.",
...
const mainArticles: Article[] = [
  ...
  {
    title: "NUPENG Threatens Showdown with Dangote Refinery Over Labour, Monopoly Concerns",
    category: "ENERGY",
    imageSrc: "/news/news7.png",
    href: "/article/nupeng-dangote-refinery",
  },
  {
    title: "FG Mourns Victims of Niger Boat Mishap",
    category: "NEWS",
    imageSrc: "/news/news8.png", // Using a boat image placeholder
    href: "/article/fg-mourn-boat-mishap",
  },
  {
    title: "NCDC, Financial Institutions Sign Deal to Widen Credit Access for Youth, Women",
    category: "NEWS",
    imageSrc: "/news/news9.png",
    href: "/article/ncdc-credit-access-deal",
  },
  {
    title: "Latest Airbus results reveal order for 7 A350-1000 aircraft from mystery buyer",
    category: "AVIATION",
    imageSrc: "/news/news10.png",
    href: "/article/airbus-results-order",
  },
  {
    title: "Challenger Energy Group (CEG), an isle of Man-based oil and gas company, is seeking a partner to join its offshore expansion",
    category: "ENERGY",
    imageSrc: "/news/news11.png",
    href: "/article/challenger-energy-offshore",
  },
  {
    title: "Methanol and LNG bunkering approved at Hamburg's Watersfather Hafen",
    category: "MARITIME & LOGISTICS",
    imageSrc: "/news/news12.png",
    href: "/article/methanol-lng-hamburg",
  },
  {
    title: "Additional N900bn capital injection expected in banks before year-ending",
    category: "BANKING & FINANCE",
    imageSrc: "/news/news13.png",
    href: "/article/n900bn-injection-banks",
  },
  {
    title: "Air Peace to begin direct flight from Lagos to Sao Paulo",
    category: "TRAVEL",
    imageSrc: "/news/news14.png",
    href: "/article/air-peace-lagos-sao-paulo",
  },
  {
    title: "Emirates tightens power bank policy to prevent battery fires mid-flight",
    category: "AVIATION",
    imageSrc: "/news/news15.png",
    href: "/article/emirates-battery-policy",
  },
  {
    title: "Sterling HoldCo directors invest N341.6m in company shares",
    category: "BANKING & FINANCE",
    imageSrc: "/news/news16.png",
    href: "/article/sterling-holdco-shares",
  },
  {
    title: "American Pacific Mining provides corporate update on the Palmer Project in Southeast Alaska",
    category: "MARKET",
    imageSrc: "/news/news17.png",
  ...
  return (
    ...
    >
      ...
      <div className={`absolute bottom-0  left-0 right-0 flex flex-col justify-end h-full ${padding}`}>
        <div>
          {/* Category Tag */}
          <span className="inline-block bg-[#AB2971] text-white text-[14px] font-semibold px-3.5 py-2 mb-3">
            {category}
          </span>
