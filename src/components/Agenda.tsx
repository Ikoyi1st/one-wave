...
export default function AgendaSection() {
  ...
  const agendaItems = [
    "Economic, Policy, Regulations & Geopolitics",
    "Future Financing & Investments",
    "Metering & Electricity Thefts ",
    "Technology, Innovation & Circularity ",
    "Electricity Markets Transition",
    "Electricity  Market Finance & Sustainability",
  ];
