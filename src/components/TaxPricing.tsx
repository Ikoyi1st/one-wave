...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-8 sm:p-8">
      <div className="w-full max-w-7xl p-12" style={{backgroundImage: 'url("/price-bg.png")', backgroundSize: "cover", backgroundPosition: "center" }}>
